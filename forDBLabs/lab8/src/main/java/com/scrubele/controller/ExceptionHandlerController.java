...
public class ExceptionHandlerController extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NoSuchCpuException.class)
    ...
    @ExceptionHandler(NoSuchMobileException.class)
    ...
    @ExceptionHandler(ExistsMobilesForCpuException.class)
    ...
    @ExceptionHandler(ExistsCustomerForMobileException.class)
    ...
    @ExceptionHandler(AlreadyExistsMobileInCustomerException.class)
    ...
    @ExceptionHandler(MobileAbsentException.class)
    ...
    @ExceptionHandler(CustomerHasNotMobileException.class)
